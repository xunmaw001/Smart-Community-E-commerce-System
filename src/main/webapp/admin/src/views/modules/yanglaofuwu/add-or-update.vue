    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="服务类型" prop="yanglaofuwuTypes">
                        <el-select v-model="ruleForm.yanglaofuwuTypes" :disabled="ro.yanglaofuwuTypes" placeholder="请选择服务类型">
                            <el-option
                                v-for="(item,index) in yanglaofuwuTypesOptions"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="预约时间" prop="yanglaofuwuTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.yanglaofuwuTime"
                                type="datetime"
                                placeholder="预约时间"
                                :disabled="ro.yanglaofuwuTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.yanglaofuwuTime" label="预约时间" prop="yanglaofuwuTime">
                            <span v-html="ruleForm.yanglaofuwuTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    yanglaofuwuTypes: false,
                    yanglaofuwuTime: false,
                    yonghuId: false,
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yanglaofuwu_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yanglaofuwuTypesOptions = data.data.list;
                    }
                });
                this.$http({
