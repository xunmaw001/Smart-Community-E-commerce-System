        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.zhiyuanzhePhoto" label="头像" prop="zhiyuanzhePhoto">
                        <file-upload
                            tip="点击上传头像"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.zhiyuanzhePhoto" label="头像" prop="zhiyuanzhePhoto">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="联系方式" prop="zhiyuanzhePhone">
                       <el-input v-model="ruleForm.zhiyuanzhePhone"
                                 placeholder="联系方式" clearable  :readonly="ro.zhiyuanzhePhone"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="联系方式" prop="zhiyuanzhePhone">
                           <el-input v-model="ruleForm.zhiyuanzhePhone"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="邮箱" prop="zhiyuanzheEmail">
                       <el-input v-model="ruleForm.zhiyuanzheEmail"
                                 placeholder="邮箱" clearable  :readonly="ro.zhiyuanzheEmail"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="邮箱" prop="zhiyuanzheEmail">
                           <el-input v-model="ruleForm.zhiyuanzheEmail"
