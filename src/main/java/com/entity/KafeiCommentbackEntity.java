...
public class KafeiCommentbackEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public KafeiCommentbackEntity() {

	}

	public KafeiCommentbackEntity(T t) {
		try {
     ...
     * 评价内容
     */
    @TableField(value = "kafei_commentback_text")
    ...
    public String toString() {
        return "KafeiCommentback{" +
            "id=" + id +
            ", kafeiId=" + kafeiId +
            ", yonghuId=" + yonghuId +
            ", kafeiCommentbackText=" + kafeiCommentbackText +
            ", replyText=" + replyText +
